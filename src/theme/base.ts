...
export function themeCreator(theme: string, fontRate: number): Theme {
  if (theme === 'PureLightTheme') {
    const pureLightTheme = PureLightTheme(fontRate);
    return pureLightTheme;
  } else if (theme === 'PurpleFlowTheme') {
    const purpleFlowTheme = PurpleFlowTheme(fontRate);
    return purpleFlowTheme;
  } else if (theme === 'GreyGooseTheme') {
    const greyGooseTheme = GreyGooseTheme(fontRate);
    return greyGooseTheme;
  }
}
