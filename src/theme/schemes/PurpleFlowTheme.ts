...
export const PurpleFlowTheme = (fontRate: number) =>
  createTheme({
    // direction: i18n.dir(),
    colors: {
      gradients: {
    ...
    typography: {
      ...
      h3: {
        fontWeight: 700,
        fontSize: 25 * fontRate,
        lineHeight: 1.4,
        color: colors.alpha.black[100]
      },
      h4: {
        fontWeight: 700,
        fontSize: 16 * fontRate
      },
      h5: {
        fontWeight: 700,
        fontSize: 14 * fontRate
